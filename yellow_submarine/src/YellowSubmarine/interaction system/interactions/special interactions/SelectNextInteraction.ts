...
export class SelectNextInteraction<T extends AbstractInteraction> extends InteractionManagerInteraction<T>{
    ...
    protected _start(): void {
        this._interactionManager.selectNextInteraction();
        this.endOnNextFrame();
    }
